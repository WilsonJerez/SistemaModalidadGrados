    ...
    public partial class ActualizarTribunales : Form
    {
        ...
        private void BtnFiltrarDefensa_Click(object sender, EventArgs e)
        {
            if (TxtCi.Text != "" & Validaciones.ci(TxtCi.Text) == true)
            {
                ...
                DtDefensas = ObjDefensa.SeleccionarDefensaCriterioBss(TxtNombre.Text.ToUpper(), TxtPaterno.Text.ToUpper(), TxtMaterno.Text.ToUpper(), Convert.ToInt32(TxtCi.Text), 1,1);
            }
            else
            {
                if (TxtCi.Text != "")
                ...
                DtDefensas = ObjDefensa.SeleccionarDefensaCriterioBss(TxtNombre.Text.ToUpper(), TxtPaterno.Text.ToUpper(), TxtMaterno.Text.ToUpper(), 0, 1,1);
            }
        ...
        private void ActualizarTribunales_Load_1(object sender, EventArgs e)
        {
        ...
        private void GridTribunal_CellMouseDoubleClick_1(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
        ...
        private void GridContratos_CellMouseDoubleClick_1(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
