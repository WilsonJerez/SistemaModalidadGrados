...
namespace VISTAS.DEFENSAS.Actualizar
{
    public partial class ActualizarFecha : Form
    {
        ...
        private void BtnActualizarFecha_Click_1(object sender, EventArgs e)
        {
            if (TxtFecha.Text != "")
            {
                if (IdDefensa > 0)
                {
                    VISTAS.DEFENSAS.Actualizar.ActualizarTribunalPorCambioFechaDefensa ActTribu = new ActualizarTribunalPorCambioFechaDefensa();
