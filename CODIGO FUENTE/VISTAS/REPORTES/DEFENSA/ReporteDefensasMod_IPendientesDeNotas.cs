...
{
    public partial class ReporteDefensasMod_IPendientesDeNotas : Form
    {
        public ReporteDefensasMod_IPendientesDeNotas()
        {
            InitializeComponent();
        }
        //objetos utilizados
        BSS.Bss_Defensa ObjDefensa = new BSS.Bss_Defensa();
        VISTAS.REPORTES.DEFENSA.CrDefensasModIPendientesDeNotas CrDefPenNotas = new CrDefensasModIPendientesDeNotas();
        ...
        private void ReporteDefensasMod_IPendientesDeNotas_Load(object sender, EventArgs e)
        {
        ...
        private void BtnGenerarReporte_Click(object sender, EventArgs e)
        {
            ...
            DtReporte = ObjDefensa.ReporteDefensasModIPendientesDeNotasBss();
            ...
            //cargamos el reporte
            CrDefPenNotas.Database.Tables["CAB_DEF_MOD_I_PEND_NOTAS"].SetDataSource(DtCabecera);
            CrDefPenNotas.Database.Tables["DEF_MOD_I_PEND_NOTAS"].SetDataSource(DtReporteModificado);
